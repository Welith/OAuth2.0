...
def showRestaurants():
    ...
    if 'username' not in login_session:
        return render_template('publicrestaurants', restaurants=restaurants)
    else:
...
def deleteRestaurant(restaurant_id):
    ...
    if restaurantToDelete.user_id != login_session['user_id']:
        return "<script> function myFunction() {alert('You are not allowed to delete this restaurant.');}</script><body onload='myFunction()'>"
    if request.method == 'POST':
